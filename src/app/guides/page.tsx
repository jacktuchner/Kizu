        ...
        <div className="mt-auto">
          ...
          {profile.isAvailableForCalls && !isOwn && (
            isGuideOnly ? (
              ...
              <button
                onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.location.href = `/book/${guide.id}`; }}
                className="mt-4 w-full py-2.5 bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-lg font-medium hover:from-cyan-700 hover:to-blue-700 transition-all flex items-center justify-center gap-2"
              >
    ...
    <ContentAcknowledgmentModal>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* CTA - upgrade prompt for guide-only, recordings cross-promo for others */}
          {isGuideOnly ? (
